...
**Pack spec v0.4.0, phantom spec v0.4.0, substrate spec v0.2.2, codec registry v0.5.0, container `0.4` (drafts for comment).** Nothing is numbered `1.0` or above until publication, container line included: a `0.x`
